...
export type SettingsConfigDTO = {
  ...
  providerBuild: { baseURL: string; fallbackBaseURL: string; clientVersion: string; clientIdentifier: string; clientMode: string; compactionAt?: string; tokenAuth: string; tokenAuthConfigured: boolean; userAgent: string };
  providerWeb: {
...
const settingsConfigValidator = hasShape({
  ...
  providerBuild: hasShape({ baseURL: isString, fallbackBaseURL: isString, clientVersion: isString, clientIdentifier: isString, clientMode: isString, compactionAt: isOptional(isString), tokenAuth: isString, tokenAuthConfigured: isBoolean, userAgent: isString }),
