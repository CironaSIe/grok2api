      ...
      {snapshot ? (
        <Tabs defaultValue="build" className="flex flex-col gap-7 lg:flex-row lg:items-start">
          <TabsList
            ...
            className="grid h-auto w-full max-w-full shrink-0 grid-cols-3 gap-1 overflow-visible rounded-none bg-transparent p-0 [&>span]:rounded-md [&>span]:bg-muted/70 [&>span]:shadow-none sm:grid-cols-3 lg:flex lg:w-56 lg:flex-col lg:items-stretch"
          >
            <TabsTrigger className="h-9 min-w-0 w-full shrink-0 justify-center truncate rounded-md px-2 text-xs data-[state=active]:font-medium lg:justify-start lg:px-3" value="build">{t("models.providerGrokBuild")}</TabsTrigger>
            <TabsTrigger className="h-9 min-w-0 w-full shrink-0 justify-center truncate rounded-md px-2 text-xs data-[state=active]:font-medium lg:justify-start lg:px-3" value="web">{t("settings.web.title")}</TabsTrigger>
            <TabsTrigger className="h-9 min-w-0 w-full shrink-0 justify-center truncate rounded-md px-2 text-xs data-[state=active]:font-medium lg:justify-start lg:px-3" value="console">{t("console.name")}</TabsTrigger>
            <TabsTrigger className="h-9 min-w-0 w-full shrink-0 justify-center truncate rounded-md px-2 text-xs data-[state=active]:font-medium lg:justify-start lg:px-3" value="delivery">{t("settings.groups.delivery")}</TabsTrigger>
            <TabsTrigger className="h-9 min-w-0 w-full shrink-0 justify-center truncate rounded-md px-2 text-xs data-[state=active]:font-medium lg:justify-start lg:px-3" value="policies">{t("settings.groups.policies")}</TabsTrigger>
            <TabsTrigger className="h-9 min-w-0 w-full shrink-0 justify-center truncate rounded-md px-2 text-xs data-[state=active]:font-medium lg:justify-start lg:px-3" value="about">{t("updates.title")}</TabsTrigger>
          </TabsList>
          ...
          >
            <div className="space-y-0">
              ...
              <SettingsField controlId="provider-client-mode" label={t("settings.provider.clientMode")} description={t("settings.provider.clientModeHelp")} error={form.formState.errors.providerBuild?.clientMode?.message}><Input id="provider-client-mode" {...form.register("providerBuild.clientMode")} /></SettingsField>
              <SettingsField controlId="provider-compaction-at" label={t("settings.provider.compactionAt")} description={t("settings.provider.compactionAtHelp")} error={form.formState.errors.providerBuild?.compactionAt?.message}><Input id="provider-compaction-at" placeholder="400000" {...form.register("providerBuild.compactionAt")} /></SettingsField>
          ...
          <SettingsSection title={t("settings.routing.title")}>
            ...
            <div className="mt-4 space-y-0 border-t pt-3">
              <p className="mb-2 text-xs font-medium text-muted-foreground">{t("settings.routing.cli.title")}</p>
              <SettingsField controlId="routing-cli-enabled" label={t("settings.routing.cli.enabled")} description={t("settings.routing.cli.enabledHelp")}><Controller control={form.control} name="routing.cli.enabled" render={({ field }) => <div className="flex h-9 items-center"><Switch id="routing-cli-enabled" checked={field.value} onCheckedChange={field.onChange} /></div>} /></SettingsField>
              <SettingsField controlId="routing-cli-warm-target" label={t("settings.routing.cli.warmTargetTotal")} description={t("settings.routing.cli.warmTargetTotalHelp")} error={form.formState.errors.routing?.cli?.warmTargetTotal?.message}><Input id="routing-cli-warm-target" type="number" min={0} max={100000} {...form.register("routing.cli.warmTargetTotal", { valueAsNumber: true })} /></SettingsField>
              <SettingsField controlId="routing-cli-unproven-share" label={t("settings.routing.cli.warmMaxUnprovenShare")} description={t("settings.routing.cli.warmMaxUnprovenShareHelp")} error={form.formState.errors.routing?.cli?.warmMaxUnprovenShare?.message}><Input id="routing-cli-unproven-share" type="number" min={0} max={1} step={0.01} {...form.register("routing.cli.warmMaxUnprovenShare", { valueAsNumber: true })} /></SettingsField>
              <SettingsField controlId="routing-cli-unproven-abs" label={t("settings.routing.cli.warmMaxUnprovenAbs")} description={t("settings.routing.cli.warmMaxUnprovenAbsHelp")} error={form.formState.errors.routing?.cli?.warmMaxUnprovenAbs?.message}><Input id="routing-cli-unproven-abs" type="number" min={0} max={100000} {...form.register("routing.cli.warmMaxUnprovenAbs", { valueAsNumber: true })} /></SettingsField>
              <SettingsField controlId="routing-cli-refresh-inflight" label={t("settings.routing.cli.maxRefreshInflight")} description={t("settings.routing.cli.maxRefreshInflightHelp")} error={form.formState.errors.routing?.cli?.maxRefreshInflight?.message}><Input id="routing-cli-refresh-inflight" type="number" min={0} max={1000} {...form.register("routing.cli.maxRefreshInflight", { valueAsNumber: true })} /></SettingsField>
              <SettingsField controlId="routing-cli-convert-inflight" label={t("settings.routing.cli.maxConvertInflight")} description={t("settings.routing.cli.maxConvertInflightHelp")} error={form.formState.errors.routing?.cli?.maxConvertInflight?.message}><Input id="routing-cli-convert-inflight" type="number" min={0} max={100} {...form.register("routing.cli.maxConvertInflight", { valueAsNumber: true })} /></SettingsField>
              <SettingsField controlId="routing-cli-convert-per-min" label={t("settings.routing.cli.maxConvertPerMinute")} description={t("settings.routing.cli.maxConvertPerMinuteHelp")} error={form.formState.errors.routing?.cli?.maxConvertPerMinute?.message}><Input id="routing-cli-convert-per-min" type="number" min={0} max={10000} {...form.register("routing.cli.maxConvertPerMinute", { valueAsNumber: true })} /></SettingsField>
              <SettingsField controlId="routing-cli-tick" label={t("settings.routing.cli.warmTickInterval")} description={t("settings.routing.cli.warmTickIntervalHelp")} error={form.formState.errors.routing?.cli?.warmTickInterval?.message}><Controller control={form.control} name="routing.cli.warmTickInterval" render={({ field }) => <DurationInput id="routing-cli-tick" value={field.value} onChange={field.onChange} />} /></SettingsField>
              <SettingsField controlId="routing-cli-refresh-advance" label={t("settings.routing.cli.accessRefreshAdvance")} description={t("settings.routing.cli.accessRefreshAdvanceHelp")} error={form.formState.errors.routing?.cli?.accessRefreshAdvance?.message}><Controller control={form.control} name="routing.cli.accessRefreshAdvance" render={({ field }) => <DurationInput id="routing-cli-refresh-advance" value={field.value} onChange={field.onChange} />} /></SettingsField>
              <SettingsField controlId="routing-cli-auto-unproven" label={t("settings.routing.cli.autoFillUnproven")} description={t("settings.routing.cli.autoFillUnprovenHelp")}><Controller control={form.control} name="routing.cli.autoFillUnproven" render={({ field }) => <div className="flex h-9 items-center"><Switch id="routing-cli-auto-unproven" checked={field.value} onCheckedChange={field.onChange} /></div>} /></SettingsField>
              <SettingsField controlId="routing-cli-auto-nonfree" label={t("settings.routing.cli.autoFillNonFree")} description={t("settings.routing.cli.autoFillNonFreeHelp")}><Controller control={form.control} name="routing.cli.autoFillNonFree" render={({ field }) => <div className="flex h-9 items-center"><Switch id="routing-cli-auto-nonfree" checked={field.value} onCheckedChange={field.onChange} /></div>} /></SettingsField>
              <SettingsField controlId="routing-cli-convert-on-request" label={t("settings.routing.cli.convertOnRequest")} description={t("settings.routing.cli.convertOnRequestHelp")}><Controller control={form.control} name="routing.cli.convertOnRequest" render={({ field }) => <div className="flex h-9 items-center"><Switch id="routing-cli-convert-on-request" checked={field.value} onCheckedChange={field.onChange} /></div>} /></SettingsField>
              <SettingsField controlId="routing-cli-hard-layer" label={t("settings.routing.cli.layerHardPartition")} description={t("settings.routing.cli.layerHardPartitionHelp")}><Controller control={form.control} name="routing.cli.layerHardPartition" render={({ field }) => <div className="flex h-9 items-center"><Switch id="routing-cli-hard-layer" checked={field.value} onCheckedChange={field.onChange} /></div>} /></SettingsField>
              <SettingsField controlId="routing-cli-ready-only" label={t("settings.routing.cli.selectReadyOrRefreshableOnly")} description={t("settings.routing.cli.selectReadyOrRefreshableOnlyHelp")}><Controller control={form.control} name="routing.cli.selectReadyOrRefreshableOnly" render={({ field }) => <div className="flex h-9 items-center"><Switch id="routing-cli-ready-only" checked={field.value} onCheckedChange={field.onChange} /></div>} /></SettingsField>
              <SettingsField controlId="routing-cli-auto-pioneer" label={t("settings.routing.cli.autoPioneerFromWeb")} description={t("settings.routing.cli.autoPioneerFromWebHelp")}><Controller control={form.control} name="routing.cli.autoPioneerFromWeb" render={({ field }) => <div className="flex h-9 items-center"><Switch id="routing-cli-auto-pioneer" checked={field.value} onCheckedChange={field.onChange} /></div>} /></SettingsField>
              <SettingsField controlId="routing-cli-max-pioneer" label={t("settings.routing.cli.maxPioneerPerTick")} description={t("settings.routing.cli.maxPioneerPerTickHelp")} error={form.formState.errors.routing?.cli?.maxPioneerPerTick?.message}><Input id="routing-cli-max-pioneer" type="number" min={0} max={100} {...form.register("routing.cli.maxPioneerPerTick", { valueAsNumber: true })} /></SettingsField>
              <SettingsField controlId="routing-cli-pioneer-trusted" label={t("settings.routing.cli.pioneerPreferTrusted")} description={t("settings.routing.cli.pioneerPreferTrustedHelp")}><Controller control={form.control} name="routing.cli.pioneerPreferTrusted" render={({ field }) => <div className="flex h-9 items-center"><Switch id="routing-cli-pioneer-trusted" checked={field.value} onCheckedChange={field.onChange} /></div>} /></SettingsField>
            </div>
          </SettingsSection>
