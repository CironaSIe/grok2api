  ...
  "zh-CN": {
    translation: {
      ...
      webAccountScripts: {
        ...
        pendingOnlyHint: "默认 pending：跳过已完成的步骤，不会强行全池重跑。", allDescription: "将检查全部 Grok Web 账号，仅执行尚未记录完成的步骤。",
      ...
      accounts: {
        ...
        conversionFailedTitle: "转换失败 {{failed}} 个账号",
        conversionFailedCopy: "复制全部",
        conversionFailedClose: "关闭",
        conversionClassLabel: "分类",
        conversionAccountLabel: "账号",
        conversionReasonLabel: "原因",
        conversionClassSsoDead: "SSO失效",
        conversionClassRateLimited: "限流",
        conversionClassNetworkRetry: "网络重试",
        conversionClassPermanent: "永久失败",
        conversionClassBotContaminated: "Bot标记",
        conversionClassUnknown: "未知",
        ...
        importedWithConsole: "导入完成：Web 新增 {{created}} / 更新 {{updated}}；Console 新增 {{consoleCreated}} / 更新 {{consoleUpdated}}",
        importedWithSyncAndConsole: "导入完成：Web 新增 {{created}} / 更新 {{updated}}；Console 新增 {{consoleCreated}} / 更新 {{consoleUpdated}} / 失败 {{consoleFailed}}；初始同步成功 {{synced}}，失败 {{syncFailed}}",
        importAutoSyncConsole: "同步创建 Console 投影",
        importAutoSyncConsoleHint: "同一 SSO 写入 Console 并建立关联，失败不回滚 Web。",
        importTrustedSource: "标记为可信来源（CLI）",
        importTrustedSourceHint: "写入 cli_trusted；Convert 后进入 Build L3，默认关闭。",
        cliLayer: "CLI 层",
        cliMaybeDead: "封号", tagFilter: "标签", tagCliTrusted: "可信来源", tagNoImage: "no_image", tagNsfwOn: "NSFW 已开", tagNsfwPending: "NSFW 待开",
        cliTrustedSource: {
          label: "可信来源",
          short: "trusted",
          description: "仅影响 Build CLI 分层（L3）；不是 proven，不改 Web 健康。",
          convertHint: "转换成功后把 trusted_source 写入 Build CLI profile。",
          convertInheritHint: "可信仅在导入/Web 打标；Convert 自动继承 cli_trusted，不在此勾选。",
        },
        cliPool: {
          title: "CLI 预热水位",
          ready: "READY {{ready}} / 目标 {{target}}",
          unproven: "未证 READY {{unproven}} / 上限 {{cap}}",
          empty: "暂无水位观测（预热未运行或已禁用）",
        },
      ...
      keys: {
        ...
        customSecret: "自定义密钥",
        customSecretCreateHelp: "关闭时自动生成 g2a_* 密钥；开启后可填写任意明文密钥。",
        customSecretEditHelp: "开启后将立即替换当前密钥；关闭则保留原密钥不变。",
        customSecretValue: "密钥内容",
        customSecretPlaceholder: "例如 C$ph-n0dE.a5 或完整 g2a_…",
        customSecretMask: "custom · ********",
        customSecretBadge: "自定义",
        customSecretTooShort: "自定义密钥至少 8 个字符",
        customSecretTooLong: "自定义密钥过长",
      ...
      settings: {
        ...
        routing: { title: "路由策略", stickyTTL: "会话粘性时长", stickyTTLHelp: "同一会话优先复用已选账号的有效时长；到期后重新参与调度。", cooldownBase: "基础冷却时间", cooldownBaseHelp: "账号发生可恢复故障后首次进入冷却的时长。", cooldownMax: "最大冷却时间", cooldownMaxHelp: "连续故障触发指数退避时允许达到的最长冷却时间。", capacityWait: "账号满载等待", capacityWaitHelp: "全部候选账号并发已满时，切换或失败前等待容量释放的时间。", maxAttempts: "最大尝试次数", maxAttemptsHelp: "单次请求在可用账号之间切换并重试的最大次数。", preferFreeBuild: "Grok Build Free 账号优先", preferFreeBuildHelp: "启用后优先选择已确认可用的 Free 账号，其他路由条件保持不变。", cli: { title: "CLI 分层与水位", enabled: "启用 CLI 分层调度", enabledHelp: "关闭后 Build 选号不硬分层，预热 worker 仍可停靠水位目标为 0。", warmTargetTotal: "水位目标 READY 数", warmTargetTotalHelp: "跨允许桶的 READY 目标总量（示例 20K 池建议 500）。", warmMaxUnprovenShare: "未证号占比上限", warmMaxUnprovenShareHelp: "未证 READY 不得超过目标的该比例。", warmMaxUnprovenAbs: "未证号绝对上限", warmMaxUnprovenAbsHelp: "与占比取较小值；0 表示仅按占比。", maxRefreshInflight: "RT 刷新并发", maxRefreshInflightHelp: "后台预热/调度刷新 AccessToken 的并发上限。", maxConvertInflight: "Convert 并发", maxConvertInflightHelp: "SSO→OAuth 转换并发；保持较低以降低风控。", maxConvertPerMinute: "Convert 每分钟上限", maxConvertPerMinuteHelp: "全局限流，防止瞬时大量 Convert。", warmTickInterval: "水位巡检间隔", warmTickIntervalHelp: "预热 worker 扫描与补水的周期。", accessRefreshAdvance: "Access 提前刷新", accessRefreshAdvanceHelp: "Access 过期前多久视为需刷新。", autoFillUnproven: "自动补未证号", autoFillUnprovenHelp: "水位不足时允许从 L3/L4 等未证桶补 READY。", autoFillNonFree: "自动补非免费未证", autoFillNonFreeHelp: "对 Super/付费未证账号参与预热补水。", convertOnRequest: "请求路径同步 Convert", convertOnRequestHelp: "默认关闭；开启会在请求路径同步 10–15s Convert，仅应急。", layerHardPartition: "硬分层选号", layerHardPartitionHelp: "有更优层可选时不看更差层。", selectReadyOrRefreshableOnly: "仅 READY/可刷新", selectReadyOrRefreshableOnlyHelp: "请求路径排除裸 ACQUIRE（无 RT 需 Convert）。", autoPioneerFromWeb: "水位自动开荒", autoPioneerFromWebHelp: "READY 低于目标且 Build 侧无可 RT/复活原料时，有界从 Web SSO 新建 Build（失败不废 Web）。", maxPioneerPerTick: "每 tick 开荒上限", maxPioneerPerTickHelp: "每个水位巡检周期最多启动多少条 Web→Build Convert；0 表示使用默认 5。", pioneerPreferTrusted: "开荒优先可信 SSO", pioneerPreferTrustedHelp: "优先选择带 cli_trusted 标签的 Web 账号作为开荒水源。" } },
      ...
      apiErrors: {
        ...
        accountExportLimitExceeded: "账号超过 50000 个，无法单次导出",
        accountImportFileTooLarge: "账号凭据文件总大小超过 30 MiB",
        accountImportLimitExceeded: "账号凭据超过 50000 个，无法单次导入",
        ...
        accountConversionCancelled: "转换已取消",
  ...
  en: {
    translation: {
      ...
      webAccountScripts: {
        ...
        pendingOnlyHint: "Defaults to pending-only: skips completed steps, no forced full-pool rerun.", allDescription: "All Grok Web accounts will be checked, and only unrecorded steps will run.",
      ...
      apiErrors: {
        ...
        accountExportLimitExceeded: "More than 50,000 accounts cannot be exported at once",
        accountImportFileTooLarge: "The total account credential file size exceeds 30 MiB",
        accountImportLimitExceeded: "More than 50,000 accounts cannot be imported at once",
        ...
        accountConversionCancelled: "Conversion cancelled",
