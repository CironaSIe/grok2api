  ...
  "zh-CN": {
    translation: {
      ...
      accounts: {
        ...
        importTrustedSource: "标记为可信源（CLI）",
        importTrustedSourceHint: "写入 cli_trusted；Convert 后进入 Build L3，默认关闭。",
        cliLayer: "CLI 层",
        cliMaybeDead: "封号", tagFilter: "标签", tagCliTrusted: "可信源", tagNoImage: "无图", tagNsfwOn: "NSFW 已开", tagNsfwPending: "NSFW 待开",
        cliTrustedSource: {
          label: "可信源",
          short: "trusted",
