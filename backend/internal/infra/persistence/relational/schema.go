...
var schemaIndexes = []string{
	...
	"CREATE INDEX IF NOT EXISTS idx_build_cli_profiles_next_eligible ON build_cli_profiles(next_eligible_at, account_id)",
	"CREATE INDEX IF NOT EXISTS idx_build_cli_profiles_last_success ON build_cli_profiles(last_success_at, account_id)",
