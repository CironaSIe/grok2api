...
func TestFreshSchemaContract(t *testing.T) {
	...
	assertTableColumns(t, database, "build_cli_profiles", []string{"account_id", "last_success_at", "success_count", "call_count", "trusted_source", "maybe_dead", "consecutive_403", "next_eligible_at", "token_generation", "last_cli_error_code", "updated_at"}, nil)
